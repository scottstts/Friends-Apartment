...
/* blackbody moved to lib/color.ts so apartment 19's fixtures share it; the
 * props.py port surface stays complete through this re-export. */
export { blackbody } from '../../lib/color'
